...
<head>
    ...
    <title>Non-Verbal Cues - Results</title>
    <style>
        body {{
        ...
        <div class="stats">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-label">Chunks with non-verbal cues</div>
                </div>
                <div class="stat-card">
                    <div class="stat-number">{(chunks_with_cues / total_chunks * 100 if total_chunks > 0 else 0):.1f}%</div>
                    <div class="stat-label">Percentage with cues</div>
                </div>
            </div>
        </div>
"""
...
"""
        ...
        html += """
        <div class="no-cues">
            No non-verbal cues were detected in the analyzed chunks.
        </div>
"""
...
def main() -> None:
    ...
    if len(chunks_with_cues) > 0:
        ...
        print("\nExample chunks with non-verbal cues (first 3):")
        print("=" * 60)
        for i, (_, row) in enumerate(chunks_with_cues.head(3).iterrows(), 1):
            print(f"\nExample #{i} - Cue type: {row['cue_type']}")
